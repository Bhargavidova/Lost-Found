...
function Login() {
  ...
  async function login(values) {
    ...
    try {
      ...
      toast.error('Oops 🙁! Server error occurred.', {
        position: "bottom-right",
        autoClose: 1000,
        theme: "light",
      });
    ...
    <Stack justifyContent="center" alignItems="center" width="100%" gap="20px" pt='10px'>
      <Stack direction="row" width="100%" sx={{ backgroundColor: 'primary.main' }} height="125px" gap="4px" alignItems="center" justifyContent="center">
        <Stack spacing={0} position="relative" justifyContent="center" width="100%" maxWidth="1440px" height="125px" overflow="hidden" ml={10}>
          <Typography fontSize="20px" color="white">Log In</Typography>
      ...
      <Stack alignItems="center" justifyContent="space-between" mt={3} direction="row">
        <Stack width="50%" display={{ xs: 'none', md: 'flex' }}>
          <img width="100%" src="https://i.ibb.co/G2k63ys/login-1.png" alt="img" />
        </Stack>
              ...
              <Form>
                <Stack alignItems="start" gap="10px">
                  <Stack padding={{ xs: '1rem', sm: '0' }}>
                    <Typography fontSize="20px" variant="h5"><b>Log In</b></Typography>
